...
// //? 57.Coding Meetup #11 - Coding Meetup #12 - Higher-Order Functions Series - Find GitHub admins
...
// //? 58.Coding Meetup #14 - Higher-Order Functions Series - Order the food
// You will be given an array of objects representing data about developers who have signed up to attend the next coding meetup that you are organising.
...
const orderFood = (list) =>
  list.reduce(
    (acc, cur) => ((acc[cur.meal] = (acc[cur.meal] ?? 0) + 1), acc),
    {}
  );
